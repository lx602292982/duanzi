...
package cn.lx.dz.support.database.db.table;
...
import cn.lx.dz.support.database.db.annotation.Check;
import cn.lx.dz.support.database.db.annotation.Column;
import cn.lx.dz.support.database.db.annotation.Finder;
import cn.lx.dz.support.database.db.annotation.Foreign;
import cn.lx.dz.support.database.db.annotation.Id;
import cn.lx.dz.support.database.db.annotation.NotNull;
import cn.lx.dz.support.database.db.annotation.Transient;
import cn.lx.dz.support.database.db.annotation.Unique;
import cn.lx.dz.support.database.db.converter.ColumnConverter;
import cn.lx.dz.support.database.db.converter.ColumnConverterFactory;
import cn.lx.dz.support.database.db.sqlite.FinderLazyLoader;
import cn.lx.dz.support.database.db.sqlite.ForeignLazyLoader;
...
public class ColumnUtils {
	...
	public static Class<?> getForeignEntityType(
			cn.lx.dz.support.database.db.table.Foreign foreignColumn) {
	...
	public static Class<?> getFinderTargetEntityType(
			cn.lx.dz.support.database.db.table.Finder finderColumn) {
