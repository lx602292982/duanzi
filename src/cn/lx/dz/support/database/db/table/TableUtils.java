...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, cn.lx.dz.support.database.db.table.Id> entityIdMap = new ConcurrentHashMap<String, cn.lx.dz.support.database.db.table.Id>();

    /* package */
    static synchronized cn.lx.dz.support.database.db.table.Id getId(Class<?> entityType) {
        ...
        cn.lx.dz.support.database.db.table.Id id = new cn.lx.dz.support.database.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        cn.lx.dz.support.database.db.table.Id id = getId(entityType);
